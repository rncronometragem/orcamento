...
<body>
    ...
    <div style="text-align:center;display:inline-block;">
    <form method="post" name="dataForm" action="index_ordens_busca.php">
        De: 
...
<table class="table table-hover" style="width:auto;">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $total_paginas_sql = "SELECT COUNT(*) FROM tbordens WHERE ido='$pedido'";
            ...
            $sql = "SELECT * FROM tbordens WHERE ido='$pedido' LIMIT $offset, $numerodepagina";
